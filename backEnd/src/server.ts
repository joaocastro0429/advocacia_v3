...
import { router as clientRoutes } from './clients/routes/client.routes.js'
import { ProcessRouter } from './process/routes/routes.js'
import { lawyerRoutes } from './lawyers/routes/routes.js'
import { appointmentRoutes } from './appointments/routes/routes.js'
import { petitionRoutes } from './petitions/routes/routes.js'
import { loginRouter } from './login/routes/route.js'
import { userRoutes } from './users/routes/routes.js'
import { notificationsRouter } from './notifications/routes/routes.js'
